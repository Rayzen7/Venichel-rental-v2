'use client'
import RoleUser from "@/utils/roleUser"
...
export default function NavbarUser() {
    ...
    return (
        <div className="">
            <div className="font-poppins flex justify-between items-center fixed w-full h-[11vh] px-[70px] bg-white">
            <h1 className="text-[24px] font-[600]"><span className="text-primary">Vanichel</span> Rental</h1>
                <div className="flex justify-center items-center gap-12 font-[500] text-[18px]">
                    <Link href='/user/home'>
                        <p className={`hover:text-primary cursor-pointer duration-200 ${pathname == '/user/home' ? 'text-primary' : ''}`}>Home</p>
                    </Link>
                    <Link href='/user/rent'>
                        <p className={`hover:text-primary cursor-pointer duration-200 ${pathname == '/user/rent' ? 'text-primary' : ''}`}>Rent</p>
                    </Link>
                    <Link href='/user/penalties'>
                        <p className={`hover:text-primary cursor-pointer duration-200 ${pathname == '/user/penalties' ? 'text-primary' : ''}`}>Penalties</p>
                    </Link>
                    <Link href='/user/return'>
                        <p className={`hover:text-primary cursor-pointer duration-200 ${pathname == '/user/return' ? 'text-primary' : ''}`}>Return</p>
                    </Link>
